...
#print("train_set_x_orig.shape[0] = %d" % train_set_x_orig.shape[0])
#print("train_set_x_orig.shape[1] = %d" % train_set_x_orig.shape[1])
#print("train_set_x_orig.shape[2] = %d" % train_set_x_orig.shape[2])
...
#print(arr.shape)
#reshaped = arr.reshape(arr.shape[0], arr.shape[1] * arr.shape[2] * arr.shape[3])
#print(reshaped.shape)
#transposed = reshaped.T
#print(transposed.shape)

transposed = arr.reshape(arr.shape[0], -1).T
print(transposed.shape)
...
def propagate(w, b, X, Y):
    ...
    ### START CODE HERE ### (≈ 2 lines of code)
    a_minus_y_transpose = (A - Y).T
    dw = (1 / m) * np.dot(X, a_minus_y_transpose)
    db = (1 / m) * np.sum(A - Y)
    ### END CODE HERE ###
